package ibf2021.fortuneCookieAPI.services;
...
// Make this to a service and add 2 methods - > getCookie and getCookies.
@Service
public class FortuneCookie {
	...
	public String getCookie() {
		...
		return COOKIES[sr.nextInt(COOKIES.length)];
	}
